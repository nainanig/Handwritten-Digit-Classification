...
def nnObjFunction(params, *args):
    ...
    for i in range(1,size):
        ...
        temp[0][d]=1
        yl_matrix=np.concatenate((yl_matrix,temp),axis=0)
    """
    ...
    #yl_matrix=np.ndarray([n_input,n_class])
    #yl_matrix[np.arange(len(training_label)),training_label.astype(int)]=1
    ...
    # Z_sigmoid=np.delete(Z_sigmoid,0,axis=1)
